...
import static org.scapesoft.game.player.Skills.AGILITY;
import static org.scapesoft.game.player.Skills.ATTACK;
import static org.scapesoft.game.player.Skills.CONSTRUCTION;
import static org.scapesoft.game.player.Skills.COOKING;
import static org.scapesoft.game.player.Skills.CRAFTING;
import static org.scapesoft.game.player.Skills.DEFENCE;
import static org.scapesoft.game.player.Skills.DUNGEONEERING;
import static org.scapesoft.game.player.Skills.FARMING;
import static org.scapesoft.game.player.Skills.FIREMAKING;
import static org.scapesoft.game.player.Skills.FISHING;
import static org.scapesoft.game.player.Skills.FLETCHING;
import static org.scapesoft.game.player.Skills.HERBLORE;
import static org.scapesoft.game.player.Skills.HITPOINTS;
import static org.scapesoft.game.player.Skills.HUNTER;
import static org.scapesoft.game.player.Skills.MAGIC;
import static org.scapesoft.game.player.Skills.MINING;
import static org.scapesoft.game.player.Skills.PRAYER;
import static org.scapesoft.game.player.Skills.RANGE;
import static org.scapesoft.game.player.Skills.RUNECRAFTING;
import static org.scapesoft.game.player.Skills.SLAYER;
import static org.scapesoft.game.player.Skills.SMITHING;
import static org.scapesoft.game.player.Skills.STRENGTH;
import static org.scapesoft.game.player.Skills.SUMMONING;
import static org.scapesoft.game.player.Skills.THIEVING;
import static org.scapesoft.game.player.Skills.WOODCUTTING;
...
import org.scapesoft.game.player.dialogues.impl.ResetSkillDialogue;
import org.scapesoft.game.player.dialogues.impl.SkillGuideD;
...
public class SkillTabListener extends EventListener {
	...
	public boolean handleButtonClick(Player player, int interfaceId, int buttonId, int packetId, int slotId, int itemId) {
		...
		case DefaultGameDecoder.ACTION_BUTTON1_PACKET:
			...
			player.getDialogueManager().startDialogue(SkillGuideD.class, lvlupSkill, skillMenu, skillId);
			break;
