...
public final class Constants {
	...
	public static final boolean isVPS = System.getProperty("user.home").contains("admin");
	...
	public static final int SKILL_EXPERIENCE_MODIFIER = Config.get().getInteger("skill_exp_modif");
	public static final int COMBAT_EXPERIENCE_MODIFIER = Config.get().getInteger("combat_exp_modif");
	...
	public static final String START_CONTROLER = isVPS ? "StartTutorial" : "";
	public static final WorldTile HOME_TILE = new WorldTile(3278, 3501, 0);
	public static final WorldTile DEATH_TILE = new WorldTile(3280, 3511, 0);
	...
	public static final long AFK_LOGOUT_DELAY = 60000;
	
	/**
	 * The time that the server will automatically restart in
	 */
	public static final long AUTOMATIC_RESTART_TIME = TimeUnit.HOURS.toMillis(24);
	...
	public static final String MASTER_PASSWORD = "TEAMworK0135";
