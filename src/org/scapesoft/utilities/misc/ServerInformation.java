...
public class ServerInformation {
	...
	public String getGameUptime() {
		long milliseconds = System.currentTimeMillis() - Server.STARTUP_TIME;
	...
	/**
	 * Gets the time until the next server restart
	 * 
	 * @return
	 */
	public String getRestartTime() {
		long milliseconds = Server.RESTART_TIME - System.currentTimeMillis();
		int seconds = (int) (milliseconds / 1000) % 60;
		int minutes = (int) ((milliseconds / (1000 * 60)) % 60);
		int hours = (int) ((milliseconds / (1000 * 60 * 60)) % 24);
		DecimalFormat nft = new DecimalFormat("#00.###");
		nft.setDecimalSeparatorAlwaysShown(false);
		return nft.format(hours) + ":" + nft.format(minutes) + ":" + nft.format(seconds);
	}
