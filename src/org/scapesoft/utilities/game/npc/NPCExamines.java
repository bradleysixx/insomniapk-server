...
public class NPCExamines {
	...
	private static final Map<Integer, String> EXAMINES = new HashMap<Integer, String>() {{
		put(2244, "It's the advisor of " + Constants.SERVER_NAME + ".");
		put(13968, "A forgotten hero who now hosts the Goblin Wars.");
		put(9701, "Tyluur's $0.50 whore.");
	}};
	...
	public static String getExamine(int npcId) {
		...
		if (EXAMINES.containsKey(npcId)) {
			...
			message = "I can't seem to figure out what that is.";
		}
		return message;
	}
