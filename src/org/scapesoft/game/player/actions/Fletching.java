...
public class Fletching extends Action {
	...
	public static enum Fletch {
		...
		OPAL_BOLTS(45, 877, new int[] { 879 }, new int[] { 11 }, new double[] { 16 }, new Animation(-1)),

		BLURITE_BOLTS(9376, 314, new int[] { 9139 }, new int[] { 24 }, new double[] { 10 }, new Animation(-1)),

		JADE_BOLTS(9187, 9376, new int[] { 9335 }, new int[] { 26 }, new double[] { 24 }, new Animation(-1)),

		PEARL_BOLTS(46, 9140, new int[] { 880 }, new int[] { 41 }, new double[] { 32 }, new Animation(-1)),

		SILVER_BOLTS(9382, 314, new int[] { 9145 }, new int[] { 43 }, new double[] { 25 }, new Animation(-1)),

		RED_TOPAZ_BOLTS(9188, 9141, new int[] { 9336 }, new int[] { 48 }, new double[] { 39 }, new Animation(-1)),

		BARBED_BOLTS(47, 877, new int[] { 881 }, new int[] { 51 }, new double[] { 95 }, new Animation(-1)),

		SAPPHIRE_BOLTS(9189, 9142, new int[] { 9337 }, new int[] { 56 }, new double[] { 24 }, new Animation(-1)),

		EMERALD_BOLTS(9187, 9376, new int[] { 9335 }, new int[] { 26 }, new double[] { 47 }, new Animation(-1)),

		RUBY_BOLTS(9191, 9143, new int[] { 9339 }, new int[] { 63 }, new double[] { 63 }, new Animation(-1)),

		DIAMOND_BOLTS(9192, 9143, new int[] { 9340 }, new int[] { 65 }, new double[] { 70 }, new Animation(-1)),

		DRAGON_BOLTS(9193, 9144, new int[] { 9341 }, new int[] { 71 }, new double[] { 82 }, new Animation(-1)),

		ONYX_BOLTS(9194, 9144, new int[] { 9342 }, new int[] { 73 }, new double[] { 94 }, new Animation(-1)),
