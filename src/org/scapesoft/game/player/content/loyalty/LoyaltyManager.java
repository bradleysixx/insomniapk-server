package org.scapesoft.game.player.content.loyalty;
...
public class LoyaltyManager implements Serializable {
	...
	/**
	 * Sets the points to the new value
	 * 
	 * @param points
	 *            The points to set it to
	 */
	...
	/**
	 * Sets the new users point value and sends the points config
	 *
	 * @param amount
