package org.scapesoft.game.player.content.construction;
...
import org.scapesoft.game.DynamicRegion;
import org.scapesoft.game.Region;
import org.scapesoft.game.RegionBuilder;
import org.scapesoft.game.RegionUtils;
...
import org.scapesoft.game.player.content.construction.HouseConstants.HObject;
...
import org.scapesoft.game.player.dialogues.impl.WeaponSelection;
...
public class House implements Serializable {
	...
	public void build(int slot) {
		...
		if (build.isWater() ? !hasWaterCan() : (!player.getInventory().contains(HouseConstants.HAMMER) || !player.getInventory().contains(HouseConstants.SAW))) {
