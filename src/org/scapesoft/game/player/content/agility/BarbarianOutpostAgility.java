...
import org.scapesoft.game.player.content.achievements.impl.BarbarianMediumAchievement;
...
public class BarbarianOutpostAgility {
	...
	public static void walkAcrossBalancingLedge(final Player player, final WorldObject object) {
		...
		if (!(player.getX() == 2536 && player.getY() == 3547 && player.getPlane() == 1)) {
			player.sendMessage("You cannot walk across the ledge from here.");
			return;
		}
