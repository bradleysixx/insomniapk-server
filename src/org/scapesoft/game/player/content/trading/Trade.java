package org.scapesoft.game.player.content.trading;
...
public class Trade {
	...
	public void sendValue(int slot, boolean traders) {
		...
		int price = GsonHandler.<ExchangePriceLoader> getJsonLoader(ExchangePriceLoader.class).getAveragePrice(item.getId());
	...
	public int getTradeWealth() {
		...
		for (Item item : items.getItems()) {
			...
			wealth += GsonHandler.<ExchangePriceLoader> getJsonLoader(ExchangePriceLoader.class).getAveragePrice(item.getId()) * item.getAmount();
		}
		return wealth;
	}
