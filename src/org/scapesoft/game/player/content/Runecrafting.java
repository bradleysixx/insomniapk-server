...
public final class Runecrafting {
	...
	public static void fillPouch(Player p, int i) {
		...
		// essenceToAdd *= p.getInventory().getItems().getNumberOf(i);
		if (essenceToAdd > 0) {
	...
	public enum Talismans {
		...
		AIR(1438, 2841, 4829, 0),
		EARTH(1440, 2655, 4830, 0),
		FIRE(1442, 2577, 4846, 0),
		WATER(1444, 3493, 4832, 0),
		BODY(1446, 2520, 4833, 0), 
		MIND(1448, 2792, 4834, 0), 
		BLOOD(1450, 2468, 4889, 1), 
		CHAOS(1452, 2281, 4837, 0), 
		COSMIC(1454, 2162, 4833, 0), 
		DEATH(1456, 2208, 4830, 0, 0), 
		LAW(1458, 2464, 4818, 0), 
		NATURE(1462, 2400, 4835, 0);
