package org.scapesoft.game.player.content.exchange;
...
import org.scapesoft.api.event.listeners.interfaces.GrandExchangeListener;
...
import org.scapesoft.game.player.content.exchange.ExchangeConfiguration.Progress;
...
public class ExchangeManagement {
	...
	public static void chooseBuyItem(Player player, int itemId) {
		...
		ExchangePriceLoader priceLoader = GsonHandler.getJsonLoader(ExchangePriceLoader.class);
