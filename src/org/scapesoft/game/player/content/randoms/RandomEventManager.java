package org.scapesoft.game.player.content.randoms;
...
import org.scapesoft.game.player.content.randoms.impl.Max_the_Traveller;
...
public class RandomEventManager {
	...
	public void initialize() {
		try {
			Max_the_Traveller jekyll = Max_the_Traveller.class.newInstance();
			randomEvents.put(jekyll.getName(), jekyll);
