...
public abstract class WildernessActivity {
	 ...
	 * wilderness activity. If they do receive a bonus, they will also receive
	 * {@link #getBonusPoints()} wilderness points if they're lucky. Their
	 * chance is based on {@link #getPointChance()}
	 * 
	 * @param player
	 *            The player
	 * @param params
	...
	/**
	 * The amount of bonus wilderness points to give the player if they are
	 * lucky enough. Chance of reward is {@link #getPointChance()}
	 * 
	 * @return
	 */
	...
	public void giveBonusPoints(Player player) {
		...
		if (Utils.percentageChance(getPointChance(player))) {
			...
			player.getFacade().addWildernessPoints(amount);
