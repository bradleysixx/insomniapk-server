package org.scapesoft.game.npc.others.pet;
...
import org.scapesoft.game.player.content.pet.PetDetails;
import org.scapesoft.game.player.content.pet.Pets;
...
public final class Pet extends NPC {
	...
	public void pickup() {
		if (owner.getInventory().getFreeSlots() < 1) {
			owner.getDialogueManager().startDialogue(SimpleMessage.class,
					"You must free space in your inventory to pick up your pet.");
			return;
		}
